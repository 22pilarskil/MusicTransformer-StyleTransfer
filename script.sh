...
sh generate.sh jazz 0 classical 0 $length 0
sh generate.sh jazz 0 jazz 0 $length 0
sh generate.sh jazz 0 classical 1 $length 0
sh generate.sh jazz 0 jazz 1 $length 0
